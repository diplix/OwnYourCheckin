  ...
  <div class="row">
    <div class="col-md-4">
      <form role="form">
        ...
        <div class="form-group">
          <label for="photo_syndication">Foursquare URL (<code>syndication</code>)</label>
    ...
    <div class="col-md-8">
      ...
      <p>Click the "Test" button to send a Micropub request with this photo to your endpoint. After you successfully handle the request and post this photo to your site, the real-time stream will be enabled for your Foursquare account.</p>
...
<?php else: ?>
  <p>We couldn't find any photos in your Foursquare account. Come back after you've posted a photo.</p>
<?php endif; ?>
